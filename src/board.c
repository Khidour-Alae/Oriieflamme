...
board createBoard(){
    ...
    // card fise = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card fisa = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card fc = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card ecologiie = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card liiens = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card soiree_sans_alcool = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card alcool = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card cafe = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card the = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card ecocup = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card reprographie = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card isolation_du_batiment = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card parcours_sobriete_numerique = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card heures_supplementaires = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card kahina_bouchama = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card kevin_goilard = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card massinissa_merabet = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card vitera_y = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card jonas_senizergues = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card fetia_bannour = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card catherine_dubois = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card anne_laure_ligozat = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card guillaume_burel = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card christophe_mouilleron = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card thomas_lim = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card julien_forest = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card dimitri_watel = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card djibril_aurelien_dembele_cabot = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card eric_lejeune = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card lucienne_pacave = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card katrin_salhab = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
    // card laurent_prevel = const_card(getCardName_json(jsP,0), getCardDescription_json(jsP,0), getCardId_json(jsP,0), getCardOccurences_json(jsP,0));
